...
#Vars
SRVRNICK = "csgo-bleh"
CMDLINE = "-game csgo -console -debug -usercon -maxplayers_override 24 -tickrate 64 -condebug -nobots +map cs_tomte -ip 123.456.789.11 -port 27015 +game_type 0 +game_mode 0"
